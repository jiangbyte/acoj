...
export function fetchNoticeRemove(data: any) { return request.Post<Service.ResponseResult>('/api/v1/sys/notice/remove', data) }
export function fetchNoticeDetail(params: any) { return request.Get<Service.ResponseResult>('/api/v1/sys/notice/detail', { params }) }
