...
export function fetchConfigListByCategory(params: any) {
  return request.Get<Service.ResponseResult>('/api/v1/sys/config/list-by-category', { params })
}
...
export function fetchConfigRemove(data: any) {
  return request.Post<Service.ResponseResult>('/api/v1/sys/config/remove', data)
}
export function fetchConfigDetail(params: any) {
