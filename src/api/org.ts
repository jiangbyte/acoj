...
export function fetchOrgPage(params: any) {
  return request.Get<Service.ResponseResult<Service.PageResult>>('/api/v1/sys/org/page', { params })
}
...
export function fetchOrgGrantRole(data: any) {
  return request.Post<Service.ResponseResult>('/api/v1/sys/org/grant-role', data)
}
export function fetchOrgOwnRoles(params: any) {
  return request.Get<Service.ResponseResult>('/api/v1/sys/org/own-roles', { params })
}
