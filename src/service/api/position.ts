...
export function fetchPositionRemove(data: any) { return request.Post<Service.ResponseResult>('/api/v1/sys/position/remove', data) }
export function fetchPositionDetail(params: any) { return request.Get<Service.ResponseResult>('/api/v1/sys/position/detail', { params }) }
