...
**文件**：`sdk/storage/local_storage.py`
...
```python
from sdk.storage.local_storage import LocalStorage
...
**文件**：`sdk/storage/minio_storage.py`
...
```python
from sdk.storage.minio_storage import MinioStorage
...
```python
from sdk.storage.s3_storage import S3Storage
...
```python
from sdk.storage.interface import FileStorageInterface
