...
```python
from core.middleware.trace import TraceMiddleware
...
**文件**：`core/middleware/exception.py`
...
```python
from core.middleware.exception import setup_exception_handlers
...
**文件**：`core/auth/decorator/hei_client_check_login.py`
...
**文件**：`core/auth/decorator/hei_check_permission.py`
...
**文件**：`core/auth/decorator/hei_client_check_permission.py`
...
**文件**：`core/auth/decorator/hei_check_role.py`

检查当前用户是否拥有指定的角色。

```python
from core.auth.decorator import HeiCheckRole
...
**文件**：`core/auth/decorator/hei_client_check_role.py`
...
**文件**：`core/auth/decorator/norepeat.py`
