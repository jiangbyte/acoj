...
from app.core.schema.base import ClassIdQuery, IdQuery, IdsRequest, to_schema, to_schema_list
from app.core.security.session import SessionPayload
from app.modules.biz.clazz.enums import ClassStatus, ClassVisibility
from app.modules.biz.clazz.clazz.model import OjClass
...
class OjClassService:
    ...
    async def detail_portal(self, query: IdQuery, session: SessionPayload | None = None) -> OjClassSchema:
        class_id = query.id
    ...
    async def member_list(
        self, query: ClassIdQuery, session: SessionPayload | None = None, admin: bool = False
    ) -> list[OjClassMemberSchema]:
