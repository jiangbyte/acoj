...
class OjProblemType(Base, TimestampMixin):
    __tablename__ = "oj_problem_type"
    __table_args__ = (UniqueConstraint("code", name="uq_oj_problem_type_code"),)

    id: Mapped[str] = mapped_column(String(64), primary_key=True, nullable=False, default=generate_snowflake_id, comment="主键")
    code: Mapped[str] = mapped_column(String(32), nullable=False, comment="类型编码")
