...
class DailyAdminPageQuery(PageQuery):
    from_date: date | None = None
    to_date: date | None = None


class DailyTodayQuery(ApiSchema):
    account_id: str | None = None


class DailyCalendarQuery(ApiSchema):
    year: int
    month: int
...
class DailyService:
    ...
    def _resolve_account_id(
        ...
        query: DailyTodayQuery | None = None,
    ) -> str | None:
    ...
    async def today(
        ...
        *,
        ...
        account_id = self._resolve_account_id(session, query)
        today = shanghai_today()
        row = (
