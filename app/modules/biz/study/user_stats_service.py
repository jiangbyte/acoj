...
from app.modules.biz.study.daily_service import DailyService
...
class UserStatsService:
    ...
    async def stats(self, account_id: str) -> UserStatsSchema:
        if not account_id:
        ...
        streak = (await DailyService(self.db).today(account_id)).streak
    ...
    async def heatmap(self, account_id: str, year: int) -> UserHeatmapSchema:
    ...
    async def recent_solved(self, account_id: str, pagination: PageQuery) -> PageData[RecentSolvedItem]:
