...
class MsgGroup(Base, TimestampMixin):
    ...
    owner_account_type: Mapped[str] = mapped_column(String(32), nullable=False, comment="群主账户类型")
...
class MsgGroupJoinRequest(Base, TimestampMixin):
    ...
    status: Mapped[str] = mapped_column(String(32), nullable=False, default="PENDING", comment="状态")
