...
from sqlalchemy import JSON, Boolean, DateTime, Float, Integer, Numeric, String, Text, UniqueConstraint, Index
...
class MsgFriendRequest(Base, TimestampMixin):
    ...
    status: Mapped[str] = mapped_column(String(32), nullable=False, comment="状态: PENDING/ACCEPTED/REJECTED")
