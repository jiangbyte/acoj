...
class MsgTerminal(Base, TimestampMixin):
    ...
    last_online_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), comment="最后在线时间")
    last_login_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, comment="最后登录时间")
