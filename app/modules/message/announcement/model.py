...
class MsgAnnouncement(Base, TimestampMixin):
    ...
    publish_locations: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, comment="发布位置列表")
    is_pinned: Mapped[bool] = mapped_column(Boolean, nullable=False, comment="是否置顶")
    pinned_until: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), comment="置顶截止时间")
