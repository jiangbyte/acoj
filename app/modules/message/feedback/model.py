...
class MsgFeedback(Base, TimestampMixin):
    ...
    attach_urls: Mapped[list] = mapped_column(JSON, nullable=False, default=list, comment="附件URL列表")
    ...
    submitter_account_type: Mapped[str] = mapped_column(String(32), nullable=False, comment="提交者账户类型")
    submitter_account_id: Mapped[str] = mapped_column(String(64), nullable=False, comment="提交者账户ID")
