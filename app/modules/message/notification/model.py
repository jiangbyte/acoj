...
from sqlalchemy import JSON, Boolean, DateTime, Float, Integer, Numeric, String, Text, UniqueConstraint, func
...
class MsgNotification(Base, TimestampMixin):
    ...
    target_account_types: Mapped[list] = mapped_column(JSON, nullable=False, default=list, comment="目标账户类型列表")
    target_account_ids: Mapped[list] = mapped_column(JSON, nullable=False, default=list, comment="目标账户ID列表")
    target_dept_ids: Mapped[list] = mapped_column(JSON, nullable=False, default=list, comment="目标部门ID列表")
    target_role_ids: Mapped[list] = mapped_column(JSON, nullable=False, default=list, comment="目标角色ID列表")
...
class MsgNotificationRead(Base):
    ...
    read_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=func.now, comment="阅读时间")
