...
class OjVoteAdminPageQuery(ApiSchema):
...
class OjVoteTimestampSchema(ApiSchema):
...
class OjVoteCreateRequest(ApiSchema):
    target_type: OjVoteTargetType
    target_id: str = Field(min_length=1, max_length=64)
    account_type: str = Field(min_length=1, max_length=32)
    account_id: str = Field(min_length=1, max_length=64)
    vote_type: OjVoteType = OjVoteType.LIKE
    score: int = 1


class OjVoteUpdateRequest(OjVoteCreateRequest):
    id: str = Field(min_length=1, max_length=64)


class OjVoteSchema(OjVoteCreateRequest, OjVoteTimestampSchema):
    id: str
