...
class OjAnnouncementAdminPageQuery(ApiSchema):
...
class OjAnnouncementTimestampSchema(ApiSchema):
...
class OjAnnouncementCreateRequest(ApiSchema):
    scope: OjAnnouncementScope = OjAnnouncementScope.GLOBAL
    contest_id: str | None = Field(default=None, max_length=64)
...
class OjAnnouncementUpdateRequest(OjAnnouncementCreateRequest):
    id: str = Field(min_length=1, max_length=64)


class OjAnnouncementSchema(OjAnnouncementCreateRequest, OjAnnouncementTimestampSchema):
    id: str
