...
class OjProblemTagRelationAdminPageQuery(ApiSchema):
...
class OjProblemTagRelationTimestampSchema(ApiSchema):
...
class OjProblemTagRelationCreateRequest(ApiSchema):
    problem_id: str = Field(min_length=1, max_length=64)
    tag_id: str = Field(min_length=1, max_length=64)


class OjProblemTagRelationUpdateRequest(OjProblemTagRelationCreateRequest):
    id: str = Field(min_length=1, max_length=64)


class OjProblemTagRelationSchema(
    OjProblemTagRelationCreateRequest, OjProblemTagRelationTimestampSchema
):
    id: str
