...
class OjProblemMemberAdminPageQuery(ApiSchema):
...
class OjProblemMemberTimestampSchema(ApiSchema):
...
class OjProblemMemberCreateRequest(ApiSchema):
    problem_id: str = Field(min_length=1, max_length=64)
    account_type: str = Field(min_length=1, max_length=32)
    account_id: str = Field(min_length=1, max_length=64)
    role: OjProblemMemberRole = OjProblemMemberRole.VIEWER


class OjProblemMemberUpdateRequest(OjProblemMemberCreateRequest):
    id: str = Field(min_length=1, max_length=64)


class OjProblemMemberSchema(OjProblemMemberCreateRequest, OjProblemMemberTimestampSchema):
    id: str
