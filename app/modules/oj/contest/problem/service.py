...
from app.modules.oj.contest.problem.repository import OjContestProblemRepository
...
class OjContestProblemService:
    """OJ contest problem 服务，负责基础维护查询。"""
    ...
    async def detail(self, query: IdQuery) -> OjContestProblemSchema:
        return to_schema(OjContestProblemSchema, await self.repo.get_required(query.id))
