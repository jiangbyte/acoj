...
from app.modules.oj.contest.contest.service import OjContestService
...
@router.post(
    ...
    dependencies=[
        ...
        Depends(require_permission("oj:contests:create")),
    ],
...
async def create(
    ...
    await OjContestService(db).create(payload)
    return success()
...
@router.post(
    ...
    dependencies=[
        Depends(require_account_type(AccountType.ADMIN)),
        Depends(require_permission("oj:contests:update")),
    ],
    response_model=ApiResponse[None],
)
async def update(
...
@router.post(
    ...
    dependencies=[
        Depends(require_account_type(AccountType.ADMIN)),
        Depends(require_permission("oj:contests:delete")),
    ],
    response_model=ApiResponse[None],
)
async def delete(
...
@router.get(
    ...
    dependencies=[
        Depends(require_account_type(AccountType.ADMIN)),
        Depends(require_permission("oj:contests:detail")),
    ],
...
@router.get(
    ...
    dependencies=[
        Depends(require_account_type(AccountType.ADMIN)),
        Depends(require_permission("oj:contests:page")),
    ],
