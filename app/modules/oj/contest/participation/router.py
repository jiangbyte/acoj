...
from app.modules.oj.contest.participation.service import OjContestParticipationService
...
async def detail(
    ...
    return success(await OjContestParticipationService(db).detail(IdQuery(id=id)))
