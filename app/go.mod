...
replace hei-gin/plugins/plugin-sys => ../plugins/plugin-sys

replace hei-gin/plugins/plugin-client => ../plugins/plugin-client

replace hei-gin/plugins/plugin-im => ../plugins/plugin-im
