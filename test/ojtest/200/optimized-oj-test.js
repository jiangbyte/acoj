...
export const options = {
  ...
  // { duration: '10s', target: 0 },      // 瞬间停止：无需缓慢降压，测完即停
    ...
    // ==================== 180用户测试 - 压力测试 (快速版) ====================
// { duration: '10s', target: 40 },     // 极速预热：快速拉起基础线程
// { duration: '20s', target: 180 },    // 陡峭爬升：迅速冲击极限值，观察系统抗冲击能力
// { duration: '45s', target: 180 },    // 核心观测：45秒足以捕捉超时、报错和P99延迟抖动
// { duration: '5s',  target: 0 },      // 立即切断：极限测试后无需缓慢降压，防止故障扩散

    // ==================== 200用户测试 - 稳定性验证 (快速版) ====================
  { duration: '30s', target: 90 },   // 原30s -> 12s: 快速爬到第一台阶
  { duration: '80s', target: 180 },  // 原1m  -> 24s: 继续爬升到第二台阶
  { duration: '2m', target: 200 },  // 原2m  -> 48s: 爬到峰值并维持近1分钟 (核心观测)
  { duration: '40s', target: 100 },
  { duration: '30s', target: 0 }     // 原30s -> 10s: 快速归零
  ],
};
