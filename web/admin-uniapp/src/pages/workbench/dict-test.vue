    ...
    <view class="px-4 py-4">
      ...
      <view class="bg-white rounded p-3 mb-3">
        <text class="text-sm font-semibold text-gray-700 mb-2 block"
          >1. dictTypeList('COMMON_STATUS')</text
        >
      ...
      <view class="bg-white rounded p-3 mb-3">
        <text class="text-sm font-semibold text-gray-700 mb-2 block"
          >2. dictTypeList('RESOURCE_TYPE')</text
        >
        <u-table border="1" :show-summary="false">
          ...
          <u-tr v-for="item in resourceTypeItems" :key="item.value">
            ...
            <u-td
              ><text class="text-gray-500">{{ item.value }}</text></u-td
            >
            <u-td>
              <view
      ...
      <view class="bg-white rounded p-3 mb-3">
        <text class="text-sm font-semibold text-gray-700 mb-2 block"
          >3. dictTypeData('ACCOUNT_STATUS', value) — 值转标签</text
        >
      ...
      <view class="bg-white rounded p-3 mb-3">
        <text class="text-sm font-semibold text-gray-700 mb-2 block"
          >4. dictTypeColor('NOTIFICATION_SEVERITY', value) — 获取颜色</text
        >
      ...
      <view class="bg-white rounded p-3 mb-3">
        <text class="text-sm font-semibold text-gray-700 mb-2 block"
          >5. dictList('DATA_SCOPE') — 下拉选择</text
        >
        <u-select
          v-model="showSelect"
          :list="dataScopeList"
