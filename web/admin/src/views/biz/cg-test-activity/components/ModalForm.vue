<!--
  ...
  Author: Charlie
  Generated at: 2026-07-19 10:11:30
-->
...
function normalizeFormData(data: Record<string, any> = {}) {
  return {
    ...defaultFormData,
    ...data,
    start_at: normalizeDateTimeValue(data.start_at),
    end_at: normalizeDateTimeValue(data.end_at),
...
function normalizeSubmitData(data: Record<string, any>) {
  return {
    ...data,
    start_at: normalizeSubmitDateTimeValue(data.start_at),
    end_at: normalizeSubmitDateTimeValue(data.end_at),
