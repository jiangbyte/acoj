<!--
  ...
  Author: Charlie
  Generated at: 2026-07-19 10:42:28
-->
...
function normalizeFormData(data: Record<string, any> = {}) {
  return {
    ...defaultFormData,
    ...data,
    ordered_at: normalizeDateTimeValue(data.ordered_at),
    paid_at: normalizeDateTimeValue(data.paid_at),
...
function normalizeSubmitData(data: Record<string, any>) {
  return {
    ...data,
    ordered_at: normalizeSubmitDateTimeValue(data.ordered_at),
    paid_at: normalizeSubmitDateTimeValue(data.paid_at),
