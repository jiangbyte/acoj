...
const modalTitle = computed(() => state.dataId ? '编辑竞赛人员' : '新增竞赛人员')
...
async function submitForm() {
  ...
  try {
    ...
    if (state.dataId) {
      await ojContestStaffApi.update(contestId.value, { ...payload, id: state.dataId })
      window.$message.success('更新成功')
    } else {
      await ojContestStaffApi.create(contestId.value, { ...payload, contest_id: contestId.value })
