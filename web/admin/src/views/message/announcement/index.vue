...
const tableColumns = computed<ProDataTableColumns<any>>(() => [
  ...
  { title: '标题', path: 'title', width: 150, ellipsis: { tooltip: true } },
  { title: '内容', path: 'content', width: 150, ellipsis: { tooltip: true } },
  { title: '内容格式', path: 'content_type', width: 150, ellipsis: { tooltip: true } },
  { title: '等级', path: 'severity', width: 150, ellipsis: { tooltip: true } },
  { title: '目标范围', path: 'target_scope', width: 150, ellipsis: { tooltip: true } },
  { title: '目标账户类型', path: 'target_account_type', width: 150, ellipsis: { tooltip: true } },
  { title: '发布位置列表', path: 'publish_locations', width: 150, ellipsis: { tooltip: true } },
