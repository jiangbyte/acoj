...
<template>
  <NModal v-model:show="state.showModal" preset="card" draggable :mask-closable="false" title="通知管理详情" style="width: 680px">
    <NScrollbar class="max-h-[min(620px,calc(100vh-300px))] pr-16px">
      <NSpin :show="state.loading">
        <NDescriptions label-placement="left" bordered :column="1">
          ...
          <NDescriptionsItem label="目标账户ID">
            {{ displayValue(state.detail.target_account_id) }}
          </NDescriptionsItem>
          <NDescriptionsItem label="发送者账户类型">
            {{ displayValue(state.detail.sender_account_type) }}
          </NDescriptionsItem>
          <NDescriptionsItem label="发送者账户ID">
            {{ displayValue(state.detail.sender_account_id) }}
          </NDescriptionsItem>
          <NDescriptionsItem label="来源模块">
            {{ displayValue(state.detail.source_type) }}
          </NDescriptionsItem>
          <NDescriptionsItem label="来源业务ID">
            {{ displayValue(state.detail.source_id) }}
          </NDescriptionsItem>
