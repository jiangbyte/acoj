...
export function submissionPage(params: any) {
  return http.get<any>(`${prefix}/biz/submission/page`, {
    params,
    addToken: false,
  })
}
...
export function submissionDetail(id: string) {
  return http.get<any>(`${prefix}/biz/submission/detail`, {
    params: { id },
    addToken: false,
  })
}
...
export function submissionPerformance(id: string) {
  return http.get<any>(`${prefix}/biz/submission/performance`, {
    params: { id },
  })
}

export function submissionSimilar(id: string, size = 10) {
  return http.get<any>(`${prefix}/biz/submission/similar`, {
    params: { id, size },
  })
}

export function myLatestPracticeAc(problemId: string) {
  return http.get<any>(`${prefix}/biz/submission/my-latest-ac`, {
    params: { problem_id: problemId },
  })
}

export function mySubmissionStats() {
  return http.get<any>(`${prefix}/biz/submission/my-stats`)
}
