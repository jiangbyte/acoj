  ...
  <ATooltip :title="t('locale.switch')">
    <ADropdown placement="bottomRight" :trigger="['click']">
      <button
        ...
        :class="buttonClass"
        class="inline-flex h-10 min-w-10 cursor-pointer items-center justify-center rounded-2 border-0 bg-transparent px-2 text-16px text-slate-600 transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/35 dark:text-zinc-300 dark:hover:bg-zinc-800"
        type="button"
      >
        <GlobalOutlined />
