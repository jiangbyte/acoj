            ...
            <div class="min-w-0 flex-1 pb-1">
              <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                <div class="min-w-0">
                  ...
                  <p class="mt-3 max-w-4xl text-sm leading-6 text-[var(--text-color-2)] sm:text-base">
                    {{ signature }}
                  </p>
                </div>
            ...
            <div class="grid gap-4 px-4 py-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:px-8">
              <div class="min-w-0 space-y-4">
                <div class="grid gap-4 lg:hidden">
                  <section class="rounded border border-[var(--border-color)] bg-[var(--card-color)] p-5">
                  ...
                  <div class="divide-y divide-[var(--border-color)]">
                    <div v-for="item in homeFeeds" :key="item.id" class="flex gap-4 p-5">
                      ...
                      <div class="min-w-0 flex-1">
                        <div class="flex flex-wrap items-center gap-2 text-xs text-[var(--text-color-3)]">
                          <span>{{ item.type }}</span>
                          <span>{{ item.time }}</span>
                        </div>
                  ...
                  <div v-for="item in videos" :key="item.id" class="min-w-0">
                    ...
                    >
                      <div class="flex h-full items-end justify-between">
                        ...
                        />
                        <span class="rounded bg-[var(--card-color)] px-2 py-1 text-xs text-[var(--text-color-3)]">
                          {{ item.meta }}
                        </span>
                      </div>
                    </div>
                ...
                <div class="grid gap-4 p-5 md:grid-cols-2">
                  ...
                  >
                    <div class="flex items-start gap-4">
                      ...
                      >
                        <span v-for="index in 4" :key="index" class="rounded bg-[var(--body-color)]" />
                      </div>
                      <div class="min-w-0">
...
.space-tabs :deep(.n-tabs-tab) {
  padding-right: 18px;
  padding-left: 18px;
  font-weight: 650;
}

.space-tabs :deep(.n-tabs-pane-wrapper) {
