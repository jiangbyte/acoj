...
import { LearningPlanListPage } from '@/pages/study/plans'
import { LearningPlanDetailPage } from '@/pages/study/plans/detail'
import { ProblemListDetailPage } from '@/pages/study/lists/detail'
