> 本 OJ 已经过“**阉割**”，功能简化，作为毕设使用！
>
> 全新版本 Python + FastApi 将在完成 Hei 系列开发框架的 Python 版本后**重构**！
...
AC OJ 是一款基于 Java 生态与 Vue 3 构建的在线评测系统，提供从题目管理、代码评测到用户体系的全流程解决方案。系统融合了 AI 辅助编程能力，支持多语言代码实时评测，为编程学习、算法训练提供学习平台。
