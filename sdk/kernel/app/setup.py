...
from sdk.web.middleware import setup_cors, setup_exception_handlers, AuthMiddleware, TraceMiddleware
...
def create_app() -> FastAPI:
    ...
    from sdk.kernel.plugin import discover_and_load, init_plugins
    ...
    from sdk.kernel.plugin import execute_middlewares

    execute_middlewares(app)

    # ── 4. Plugin-supplied routes ────────────────────────────────────
    from sdk.kernel.plugin import execute_routes
