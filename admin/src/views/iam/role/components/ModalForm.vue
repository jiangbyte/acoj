...
import { createRequiredRule, toNullableString, wireFields } from '@/utils'
...
async function fetchDetail(id: string) {
  ...
  try {
    ...
    state.formModel = {
      ...defaultFormData,
      ...response.data,
      ...wireFields(response.data, { sort: 'int', is_builtin: 'bool' }, defaultFormData),
...
async function submitForm() {
  ...
  try {
    const payload = {
      ...
      is_builtin: state.formModel.is_builtin,
