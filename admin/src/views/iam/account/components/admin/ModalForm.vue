...
import { displayValue, formatDateTime, hasPermission, toNullableString } from '@/utils'
...
const state = reactive({
  ...
  formModel: { ...defaultFormData } as AccountFormModel,
...
async function fetchDetail(id: string) {
  ...
  try {
    ...
    state.detail = data
    state.formModel = mapAccountFormFromDetail(data, ACCOUNT_TYPE, { includeRemark: true })
...
async function submitForm() {
  ...
  try {
    const payload = {
      ...(await buildAccountPayload(state.formModel)),
