...
import { createRequiredArrayRule, createRequiredRule, dictList, formatDateTime, wireValue } from '@/utils'
...
function normalizeFormData(data: Record<string, any> = {}): Record<string, any> {
  return {
    ...
    is_pinned: wireValue(data.is_pinned, 'bool', defaultFormData.is_pinned),
