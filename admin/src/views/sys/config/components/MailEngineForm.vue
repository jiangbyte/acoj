...
const engineTabOptions = [
  { key: 'LOCAL', label: '本地邮件' },
  { key: 'ALIYUN', label: '阿里云邮件' },
  { key: 'TENCENT', label: '腾讯云邮件' },
]
...
<template>
  <NSpin :show="state.loading">
    ...
    <NTabs
      ...
      placement="left"
      :value="state.subTab"
      @update:value="(value: string) => (state.subTab = value as Engine)"
    >
      <NTabPane
        v-for="opt in engineTabOptions"
        :key="opt.key"
        :name="opt.key"
        :tab="opt.label"
      >
