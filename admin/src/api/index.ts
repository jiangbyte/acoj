...
export * as jobApi from './sys/job.ts'
...
export * as realNameApi from './sys/realName'

export * as ojProblemApi from './oj/problem'
export * as ojTagApi from './oj/tag'
export * as ojJudgeNodeApi from './oj/judge-node'
export * as ojSubmissionApi from './oj/submission'
export * as ojProblemCaseApi from './oj/problem-case'
export * as ojProblemSolutionApi from './oj/problem-solution'
