...
def upgrade() -> None:
    ...
    sa.Column('link_type', sa.String(length=16), nullable=False, comment='链接类型：Banner 链接类型，对应 BANNER_LINK_TYPE 字典组子项 value。'),
    sa.Column('summary', sa.String(length=500), nullable=True, comment='摘要'),
    sa.Column('description', sa.Text(), nullable=True, comment='描述'),
    sa.Column('category', sa.String(length=32), nullable=False, comment='分类：Banner 分类，对应 BANNER_CATEGORY 字典组子项 value。'),
    sa.Column('type', sa.String(length=32), nullable=False, comment='类型：Banner 类型，对应 BANNER_TYPE 字典组子项 value。'),
    sa.Column('position', sa.String(length=32), nullable=False, comment='显示位置：Banner 显示位置，对应 BANNER_POSITION 字典组子项 value。'),
    sa.Column('display_scope', sa.String(length=32), nullable=False, comment='显示端：Banner 显示端，对应 BANNER_DISPLAY_SCOPE 字典组子项 value。'),
    ...
    sa.Column('category', sa.String(length=64), nullable=True, comment='字典组分类：字典组分类，对应 sys_dict.category 字段的取值。'),
