...
type SessionAnalysisReq struct {
	g.Meta `path:"/api/v1/client/session/analysis" method:"get" summary:"会话分析" tags:"C端会话管理"`
}
...
type SessionPageReq struct {
	g.Meta  `path:"/api/v1/client/session/page" method:"get" summary:"分页查询会话" tags:"C端会话管理"`
...
type SessionExitReq struct {
	g.Meta `path:"/api/v1/client/session/exit" method:"post" summary:"踢下线" tags:"C端会话管理"`
...
type SessionTokensReq struct {
	g.Meta `path:"/api/v1/client/session/tokens" method:"get" summary:"获取用户token列表" tags:"C端会话管理"`
	UserId string `json:"user_id" v:"required#用户ID不能为空"`
}
...
type SessionExitTokenReq struct {
	g.Meta `path:"/api/v1/client/session/exit-token" method:"post" summary:"踢下线指定token" tags:"C端会话管理"`
	UserId string `json:"user_id" v:"required#用户ID不能为空"`
...
type SessionChartDataReq struct {
	g.Meta `path:"/api/v1/client/session/chart-data" method:"get" summary:"会话图表数据" tags:"C端会话管理"`
}
