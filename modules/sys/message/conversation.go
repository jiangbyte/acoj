...
// ConversationMessages returns messages in a conversation for a BUSINESS user.
// Uses UNION to query both sys_message and client_message.
func ConversationMessages(currentUserID string, conversationID string, cursor string, size int) ([]ConversationMessageVO, bool) {
	...
	args := []interface{}{conversationID, currentUserID, currentUserID, enums.LoginTypeBusiness}
	args = append(args, cursorArgs...)
	args = append(args, conversationID, currentUserID, enums.LoginTypeBusiness)
	args = append(args, cursorArgs...)
