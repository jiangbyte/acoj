...
class SysBanner(Base):
    ...
    link_type: Mapped[Optional[str]] = mapped_column(VARCHAR(16, charset='utf8mb4', collation='utf8mb4_general_ci'), default="URL", comment='链接类型')
    ...
    click_count: Mapped[Optional[int]] = mapped_column(Integer, default=0, comment='点击次数')
