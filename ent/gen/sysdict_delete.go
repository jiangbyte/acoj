...
func (_d *SysDictDelete) Where(ps ...predicate.SysDict) *SysDictDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *SysDictDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *SysDictDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *SysDictDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the SysDictDelete builder.
func (_d *SysDictDeleteOne) Where(ps ...predicate.SysDict) *SysDictDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *SysDictDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *SysDictDeleteOne) ExecX(ctx context.Context) {
