...
func (_q *SysConfigQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SysConfigQuery) FirstIDX(ctx context.Context) string {
...
func (_q *SysConfigQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SysConfigQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *SysConfigQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *SysConfigQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SysConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(sysconfig.Table, sysconfig.Columns, sqlgraph.NewFieldSpec(sysconfig.FieldID, field.TypeString))
	_spec.From = _q.sql
