...
func (tx *Tx) init() {
	...
	tx.SysFile = NewSysFileClient(tx.config)
	tx.SysGroup = NewSysGroupClient(tx.config)
	tx.SysLog = NewSysLogClient(tx.config)
	tx.SysModule = NewSysModuleClient(tx.config)
	tx.SysNotice = NewSysNoticeClient(tx.config)
	tx.SysOrg = NewSysOrgClient(tx.config)
	tx.SysPosition = NewSysPositionClient(tx.config)
	tx.SysQuickAction = NewSysQuickActionClient(tx.config)
	tx.SysResource = NewSysResourceClient(tx.config)
