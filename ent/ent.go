...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			sysfile.Table:           sysfile.ValidColumn,
			sysgroup.Table:          sysgroup.ValidColumn,
			syshome.Table:           syshome.ValidColumn,
			syslog.Table:            syslog.ValidColumn,
			sysnotice.Table:         sysnotice.ValidColumn,
			sysorg.Table:            sysorg.ValidColumn,
			syspermission.Table:     syspermission.ValidColumn,
			sysposition.Table:       sysposition.ValidColumn,
			sysresource.Table:       sysresource.ValidColumn,
