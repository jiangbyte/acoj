package io.charlie.web.modular.data.similarity.controller;

import cn.dev33.satoken.annotation.SaCheckPermission;
import io.charlie.cores.result.Result;
import io.charlie.web.annotation.log.Log;
import io.charlie.web.annotation.log.LogCategory;
import io.charlie.web.annotation.log.LogModule;
import io.charlie.web.modular.data.library.param.BatchLibraryQueryParam;
import io.charlie.web.modular.data.similarity.param.TaskSimilarityAddParam;
import io.charlie.web.modular.data.similarity.param.TaskSimilarityEditParam;
import io.charlie.web.modular.data.similarity.param.TaskSimilarityIdParam;
import io.charlie.web.modular.data.similarity.param.TaskSimilarityPageParam;
import io.charlie.web.modular.data.similarity.param.*;
import io.charlie.web.modular.task.similarity.dto.SimilarityProgressDto;
import io.charlie.web.modular.task.similarity.service.SimilarityService;
import io.charlie.web.modular.task.similarity.service.SimilarityProgressService;
...
import io.charlie.web.modular.data.similarity.service.TaskSimilarityService;
