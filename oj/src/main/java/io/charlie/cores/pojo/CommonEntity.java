...
public class CommonEntity implements Serializable, TransPojo {
     ...
     */
    @TableField(fill = FieldFill.INSERT)
    @Trans(type = TransType.SIMPLE, targetClassName = "io.charlie.web.modular.sys.user.entity.SysUser", fields = {"avatar", "nickname"}, refs = {"createUserAvatar", "createUserName"})
     ...
     */
    @TableField(fill = FieldFill.INSERT_UPDATE)
    @Trans(type = TransType.SIMPLE, targetClassName = "io.charlie.web.modular.sys.user.entity.SysUser", fields = {"avatar", "nickname"}, refs = {"updateUserAvatar", "updateUserName"})
