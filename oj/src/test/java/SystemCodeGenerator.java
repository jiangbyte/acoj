...
//        modules.add(new Module("core", "io.charlie.app.core.modular.problem.reports", List.of("pro_similarity_reports")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.set.reports", List.of("pro_set_similarity_reports")));

//        modules.add(new Module("core", "io.charlie.app.core.modular.reports", List.of("data_reports")));

//        modules.add(new Module("core", "io.charlie.app.core.modular.data.submit", List.of("data_submit")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.data.problem", List.of("data_problem")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.data.solved", List.of("data_solved")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.data.set", List.of("data_set")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.data.progress", List.of("data_progress")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.data.library", List.of("data_library")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.data.task", List.of("task_similarity")));
//        modules.add(new Module("core", "io.charlie.app.core.modular.data.task", List.of("task_reports")));



//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.article", List.of("sys_article")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.banner", List.of("sys_banner")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.category", List.of("sys_category")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.config", List.of("sys_config")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.dict", List.of("sys_dict")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.group", List.of("sys_group")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.notice", List.of("sys_notice")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.role", List.of("sys_role")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.tag", List.of("sys_tag")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.user", List.of("sys_user")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.menu", List.of("sys_menu")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.log", List.of("sys_log")));
//        modules.add(new Module("system", "io.charlie.web.oj.modular.sys.conversation", List.of("sys_conversation")));
//
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.library", List.of("data_library")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.problem", List.of("data_problem")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.progress", List.of("data_progress")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.set", List.of("data_set")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.solved", List.of("data_solved")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.submit", List.of("data_submit")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.reports", List.of("task_reports")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.similarity", List.of("task_similarity")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.testcase", List.of("data_test_case")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.judgecase", List.of("data_judge_case")));
        modules.add(new Module("data", "io.charlie.web.oj.modular.data.set", List.of("data_set_problem")));

//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.contest", List.of("data_contest")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.contest", List.of("data_contest_auth")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.contest", List.of("data_contest_problem")));
//        modules.add(new Module("data", "io.charlie.web.oj.modular.data.contest", List.of("data_contest_participant")));
