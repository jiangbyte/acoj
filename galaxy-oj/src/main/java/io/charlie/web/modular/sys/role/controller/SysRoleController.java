package io.charlie.web.modular.sys.role.controller;
...
import io.charlie.web.modular.sys.relation.service.SysRoleMenuService;
import io.charlie.web.modular.sys.role.param.*;
...
public class SysRoleController {
    ...
    public Result<?> assign(@RequestBody @Valid SysRoleAssignParam sysRoleAssignParam) {
        ...
        dataScopeUtil.refreshUserDataScope(sysRoleAssignParam.getUserId());
        return Result.success();
    }
