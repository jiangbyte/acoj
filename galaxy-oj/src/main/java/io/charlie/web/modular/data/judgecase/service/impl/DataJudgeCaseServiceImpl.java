package io.charlie.web.modular.data.judgecase.service.impl;
...
import io.charlie.web.modular.data.judgecase.entity.DataJudgeCase;
import io.charlie.web.modular.data.judgecase.param.DataJudgeCaseAddParam;
import io.charlie.web.modular.data.judgecase.param.DataJudgeCaseEditParam;
import io.charlie.web.modular.data.judgecase.param.DataJudgeCaseIdParam;
import io.charlie.web.modular.data.judgecase.param.DataJudgeCasePageParam;
import io.charlie.web.modular.data.judgecase.mapper.DataJudgeCaseMapper;
import io.charlie.web.modular.data.judgecase.service.DataJudgeCaseService;
...
public class DataJudgeCaseServiceImpl extends ServiceImpl<DataJudgeCaseMapper, DataJudgeCase> implements DataJudgeCaseService {
    ...
    public Page<DataJudgeCase> page(DataJudgeCasePageParam dataJudgeCasePageParam) {
        ...
        if (GalaxyStringUtil.isNotEmpty(dataJudgeCasePageParam.getSubmitId())) {
