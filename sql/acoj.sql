...
CREATE TABLE `data_contest`  (
  ...
  INDEX `idx_visibility_register_time`(`is_visible` ASC, `is_public` ASC, `register_start_time` ASC, `register_end_time` ASC) USING BTREE,
  INDEX `idx_status_contest_time`(`status` ASC, `contest_start_time` ASC, `contest_end_time` ASC) USING BTREE,
...
CREATE TABLE `data_contest_participant`  (
  ...
  INDEX `idx_contest_id`(`contest_id` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_contest_register_time`(`contest_id` ASC, `register_time` ASC) USING BTREE
...
CREATE TABLE `data_contest_problem`  (
  ...
  INDEX `idx_submit_count`(`submit_count` DESC) USING BTREE,
  INDEX `idx_contest_sort`(`contest_id` ASC, `sort` ASC) USING BTREE
...
CREATE TABLE `data_judge_case`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_submit_create_time`(`submit_id` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_submit_case_sign`(`submit_id` ASC, `case_sign` ASC) USING BTREE,
  INDEX `idx_submit_score`(`submit_id` ASC, `score` ASC) USING BTREE,
  INDEX `idx_submit_status`(`submit_id` ASC, `status` ASC) USING BTREE
...
CREATE TABLE `data_library`  (
  ...
  `update_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_module_problem_lang`(`user_id` ASC, `module_type` ASC, `module_id` ASC, `problem_id` ASC, `language` ASC) USING BTREE,
  INDEX `idx_module_problem_lang_time`(`module_type` ASC, `module_id` ASC, `problem_id` ASC, `language` ASC, `update_time` ASC) USING BTREE,
  INDEX `idx_user_module_lang`(`user_id` ASC, `module_type` ASC, `module_id` ASC, `language` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
...
CREATE TABLE `data_problem`  (
  ...
  `update_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_visibility_public_category_difficulty`(`is_visible` ASC, `is_public` ASC, `category_id` ASC, `difficulty` ASC) USING BTREE,
  INDEX `idx_visibility_public_create_time`(`is_visible` ASC, `is_public` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_visibility_public_difficulty`(`is_visible` ASC, `is_public` ASC, `difficulty` ASC) USING BTREE,
...
CREATE TABLE `data_problem_tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_problem_tag`(`problem_id` ASC, `tag_id` ASC) USING BTREE,
  INDEX `idx_tag_problem`(`tag_id` ASC, `problem_id` ASC) USING BTREE
...
CREATE TABLE `data_set`  (
  ...
  `update_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_visible_category_difficulty_type`(`is_visible` ASC, `category_id` ASC, `difficulty` ASC, `set_type` ASC) USING BTREE,
  INDEX `idx_title_prefix`(`title` ASC) USING BTREE,
  INDEX `idx_visible_create_time`(`is_visible` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_visible_difficulty`(`is_visible` ASC, `difficulty` ASC) USING BTREE
...
CREATE TABLE `data_set_problem`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_set_problem`(`set_id` ASC, `problem_id` ASC) USING BTREE,
  INDEX `idx_problem_set`(`problem_id` ASC, `set_id` ASC) USING BTREE,
  INDEX `idx_set_problem_sort`(`set_id` ASC, `problem_id` ASC, `sort` ASC) USING BTREE
...
CREATE TABLE `data_solved`  (
  ...
  `update_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_problem_module`(`user_id` ASC, `problem_id` ASC, `module_type` ASC, `module_id` ASC) USING BTREE,
  INDEX `idx_module_type_module_id`(`module_type` ASC, `module_id` ASC) USING BTREE,
  INDEX `idx_user_module_type_module_id`(`user_id` ASC, `module_type` ASC, `module_id` ASC) USING BTREE,
  INDEX `idx_user_module_type_module_id_problem_id`(`user_id` ASC, `module_type` ASC, `module_id` ASC, `problem_id` ASC) USING BTREE,
  INDEX `idx_user_module_type_module_id_problem_id_solved`(`user_id` ASC, `module_type` ASC, `module_id` ASC, `problem_id` ASC, `solved` ASC) USING BTREE
...
CREATE TABLE `data_submit`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_module_problem_lang_status_type`(`user_id` ASC, `module_type` ASC, `module_id` ASC, `problem_id` ASC, `language` ASC, `status` ASC, `submit_type` ASC) USING BTREE,
...
CREATE TABLE `data_test_case`  (
  ...
  INDEX `idx_problem_case_sign`(`problem_id` ASC, `case_sign` ASC) USING BTREE,
  INDEX `idx_problem_create_time`(`problem_id` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_problem_score`(`problem_id` ASC, `score` ASC) USING BTREE,
  INDEX `idx_problem_is_sample`(`problem_id` ASC, `is_sample` ASC) USING BTREE
...
CREATE TABLE `sys_article`  (
  ...
  `update_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_to_url`(`to_url` ASC) USING BTREE,
  INDEX `idx_category_type_deleted`(`category` ASC, `type` ASC, `deleted` ASC) USING BTREE,
  INDEX `idx_parent_id_deleted`(`parent_id` ASC, `deleted` ASC) USING BTREE,
  INDEX `idx_category_deleted_sort`(`category` ASC, `deleted` ASC, `sort` ASC) USING BTREE,
  INDEX `idx_deleted_create_time`(`deleted` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_title_prefix`(`title` ASC) USING BTREE,
  INDEX `idx_summary_prefix`(`summary` ASC) USING BTREE
...
CREATE TABLE `sys_banner`  (
  ...
  `update_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_visible_sort`(`is_visible` ASC, `sort` ASC) USING BTREE,
  INDEX `idx_jump_module_type`(`jump_module` ASC, `jump_type` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '横幅表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_banner
-- ----------------------------
INSERT INTO `sys_banner` VALUES ('1983071920168431618', '', '3ed0eb4a32de419e877a80cb9157cca6.jpg', '查看一下', 1, 'PERSONAL', 'ID', '1', 0, 1, '', 0, 1, 0, '2025-10-28 15:22:44', '1', '2026-08-29 20:26:03', '1');
...
CREATE TABLE `sys_config`  (
  ...
  INDEX `idx_config_type_sort`(`config_type` ASC, `sort` ASC) USING BTREE,
  INDEX `idx_code_config_type`(`code` ASC, `config_type` ASC) USING BTREE
...
CREATE TABLE `sys_dict`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_type_code`(`dict_type` ASC, `dict_value` ASC) USING BTREE,
...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('2093665328136151041', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 19:41:27', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 19:41:27', '1', '2026-08-29 19:41:27', '1');
INSERT INTO `sys_log` VALUES ('2093665396847239170', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 19:41:44', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 19:41:44', '1', '2026-08-29 19:41:44', '1');
INSERT INTO `sys_log` VALUES ('2093667246719844353', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 19:49:04', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 19:49:05', '1', '2026-08-29 19:49:05', '1');
INSERT INTO `sys_log` VALUES ('2093671277257191425', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 20:05:05', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:05:06', '1', '2026-08-29 20:05:06', '1');
INSERT INTO `sys_log` VALUES ('2093671682561175553', '1', '删除菜单', 'io.charlie.web.modular.sys.menu.controller.SysMenuController.delete', '[[{\"id\":\"1979781411367333889\"}]]', '0:0:0:0:0:0:0:1', '2026-08-29 20:06:42', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:06:42', '1', '2026-08-29 20:06:42', '1');
INSERT INTO `sys_log` VALUES ('2093671695588683777', '1', '删除菜单', 'io.charlie.web.modular.sys.menu.controller.SysMenuController.delete', '[[{\"id\":\"1979359562444050434\"}]]', '0:0:0:0:0:0:0:1', '2026-08-29 20:06:45', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:06:45', '1', '2026-08-29 20:06:45', '1');
INSERT INTO `sys_log` VALUES ('2093671707911548929', '1', '删除菜单', 'io.charlie.web.modular.sys.menu.controller.SysMenuController.delete', '[[{\"id\":\"1979792211910332418\"}]]', '0:0:0:0:0:0:0:1', '2026-08-29 20:06:48', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:06:48', '1', '2026-08-29 20:06:48', '1');
INSERT INTO `sys_log` VALUES ('2093671719563325442', '1', '删除菜单', 'io.charlie.web.modular.sys.menu.controller.SysMenuController.delete', '[[{\"id\":\"1979779968216379394\"}]]', '0:0:0:0:0:0:0:1', '2026-08-29 20:06:51', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:06:51', '1', '2026-08-29 20:06:51', '1');
INSERT INTO `sys_log` VALUES ('2093671731600977922', '1', '删除菜单', 'io.charlie.web.modular.sys.menu.controller.SysMenuController.delete', '[[{\"id\":\"1979784519254323202\"}]]', '0:0:0:0:0:0:0:1', '2026-08-29 20:06:54', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:06:54', '1', '2026-08-29 20:06:54', '1');
INSERT INTO `sys_log` VALUES ('2093671743630241793', '1', '删除菜单', 'io.charlie.web.modular.sys.menu.controller.SysMenuController.delete', '[[{\"id\":\"1979788036882870274\"}]]', '0:0:0:0:0:0:0:1', '2026-08-29 20:06:57', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:06:57', '1', '2026-08-29 20:06:57', '1');
INSERT INTO `sys_log` VALUES ('2093671758389997569', '1', '删除菜单', 'io.charlie.web.modular.sys.menu.controller.SysMenuController.delete', '[[{\"id\":\"1979358311883591681\"}]]', '0:0:0:0:0:0:0:1', '2026-08-29 20:07:00', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:07:00', '1', '2026-08-29 20:07:00', '1');
INSERT INTO `sys_log` VALUES ('2093674399136350209', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 20:17:30', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:17:30', '1', '2026-08-29 20:17:30', '1');
INSERT INTO `sys_log` VALUES ('2093676477506342914', '1', '编辑横幅', 'io.charlie.web.modular.sys.banner.controller.SysBannerController.edit', '[{\"banner\":\"http://120.26.180.149:9000/astro-code-oj/e9408faf649f491cbe800d79d95046ea.png\",\"buttonText\":\"查看一下\",\"id\":\"1983071920168431618\",\"isVisible\":true,\"isVisibleButton\":true,\"isVisibleSubtitle\":false,\"jumpModule\":\"PERSONAL\",\"jumpTarget\":\"1\",\"jumpType\":\"ID\",\"sort\":1,\"subtitle\":\"\",\"targetBlank\":false,\"title\":\"\"}]', '0:0:0:0:0:0:0:1', '2026-08-29 20:25:44', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:25:46', '1', '2026-08-29 20:25:46', '1');
INSERT INTO `sys_log` VALUES ('2093676479855153153', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 20:25:46', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:25:46', '1', '2026-08-29 20:25:46', '1');
INSERT INTO `sys_log` VALUES ('2093676541536587778', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 20:26:01', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:26:01', '1', '2026-08-29 20:26:01', '1');
INSERT INTO `sys_log` VALUES ('2093676550818582529', '1', '编辑横幅', 'io.charlie.web.modular.sys.banner.controller.SysBannerController.edit', '[{\"banner\":\"3ed0eb4a32de419e877a80cb9157cca6.jpg\",\"buttonText\":\"查看一下\",\"id\":\"1983071920168431618\",\"isVisible\":true,\"isVisibleButton\":true,\"isVisibleSubtitle\":false,\"jumpModule\":\"PERSONAL\",\"jumpTarget\":\"1\",\"jumpType\":\"ID\",\"sort\":1,\"subtitle\":\"\",\"targetBlank\":false,\"title\":\"\"}]', '0:0:0:0:0:0:0:1', '2026-08-29 20:26:03', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:26:03', '1', '2026-08-29 20:26:03', '1');
INSERT INTO `sys_log` VALUES ('2093676880373436417', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 20:27:21', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:27:22', '1', '2026-08-29 20:27:22', '1');
INSERT INTO `sys_log` VALUES ('2093677508097167361', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 20:29:51', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:29:51', '1', '2026-08-29 20:29:51', '1');
INSERT INTO `sys_log` VALUES ('2093677516670324738', '1', '编辑公告', 'io.charlie.web.modular.sys.notice.controller.SysNoticeController.edit', '[{\"content\":\"亲爱的用户：\\n\\n为了帮助大家更好地理解我们平台的判题机制，提高编程练习的效率，现将平台的判题流程和注意事项说明如下：\\n\\n## 判题流程概述\\n\\n我们的判题系统采用标准化流程对您的提交进行评测，具体流程如下：\\n\\n```mermaid\\ngraph TD\\n    A[用户提交代码] --> B[等待判题]\\n    B --> C[编译代码]\\n    C --> D{编译是否成功?}\\n    D -->|否| E[编译错误]\\n    D -->|是| F[运行程序]\\n    F --> G[比对输出]\\n    G --> H{输出是否正确?}\\n    H -->|完全正确| I[答案正确]\\n    H -->|部分正确| J[部分正确]\\n    H -->|错误| K[答案错误]\\n    F --> L{是否超时?}\\n    L -->|是| M[时间超出限制]\\n    F --> N{内存是否超限?}\\n    N -->|是| O[内存超出限制]\\n    F --> P{是否运行时错误?}\\n    P -->|是| Q[运行时错误]\\n```\\n\\n## 各编程语言配置说明\\n\\n| 语言 | 源文件要求 | 编译命令 | 运行命令 |\\n|------|------------|----------|----------|\\n| Go | Main.go | `go build -o Main Main.go` | `./Main` |\\n| Java | Main.java | `javac -d . Main.java` | `java Main` |\\n| C | Main.c | `gcc Main.c -o Main` | `./Main` |\\n| C++ | Main.cpp | `g++ Main.cpp -o Main` | `./Main` |\\n| Python | Main.py | 无需编译 | `python3 Main.py` |\\n\\n## 判题状态说明\\n\\n| 状态类型 | 状态代码 | 含义说明 |\\n|----------|----------|----------|\\n| 成功状态 | `ACCEPTED` | 程序输出完全正确 |\\n| 成功状态 | `PARTIAL_ACCEPTED` | 程序输出部分正确 |\\n| 编译相关 | `COMPILATION_ERROR` | 源代码编译失败 |\\n| 编译相关 | `COMPILED_OK` | 源代码编译成功 |\\n| 运行相关 | `TIME_LIMIT_EXCEEDED` | 程序运行超时 |\\n| 运行相关 | `MEMORY_LIMIT_EXCEEDED` | 内存使用超限 |\\n| 运行相关 | `RUNTIME_ERROR` | 程序运行时出错 |\\n| 输出相关 | `WRONG_ANSWER` | 程序输出答案错误 |\\n| 输出相关 | `PRESENTATION_ERROR` | 输出格式不符合要求 |\\n\\n## 重要注意事项\\n\\n### 1. 代码规范要求\\n- **文件命名**：系统文件将命名为`Main`（具体如`Main.java`、`Main.py`等）\\n- **入口类**：Java程序必须包含`Main`类，且该类应为`public`\\n- **程序入口**：所有程序都应有`main`函数作为程序入口点\\n\\n### 2. 输入输出要求\\n- 使用标准输入输出（`stdin/stdout`）\\n- 不要使用文件输入输出，否则会导致判题失败\\n- 输出格式必须与题目要求完全一致，包括空格、换行（末尾换行将忽略）等\\n\\n### 3. 资源限制\\n- **时间限制**：各题目有不同的时间限制，通常在`1-10`秒（显示为`ms`）之间\\n- **内存限制**：通常为`1MB-250MB`（显示为`KB`），请避免创建过大的数据结构\\n\\n### 4. 常见问题解决\\n- **编译错误**：检查语法错误、缺少分号、括号不匹配等\\n- **运行时错误**：检查数组越界、空指针、除零错误等\\n- **时间超限**：优化算法时间复杂度，避免无效循环\\n- **内存超限**：减少不必要的内存分配，使用更高效的数据结构\\n\\n## 建议与技巧\\n\\n1. **本地测试**：在提交前务必在本地进行充分测试\\n2. **边界情况**：特别注意输入数据的边界条件测试\\n3. **特殊值**：考虑空输入、极大值、极小值等情况\\n4. **代码简洁**：避免不必要的复杂逻辑，保持代码清晰\\n\\n如果您在判题过程中遇到任何问题，或有改进建议，欢迎通过反', '0:0:0:0:0:0:0:1', '2026-08-29 20:29:53', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:29:53', '1', '2026-08-29 20:29:53', '1');
INSERT INTO `sys_log` VALUES ('2093680595314626561', '1', '文件上传', 'io.charlie.web.modular.sys.file.controller.FileController.upload', NULL, '0:0:0:0:0:0:0:1', '2026-08-29 20:42:07', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:42:07', '1', '2026-08-29 20:42:07', '1');
INSERT INTO `sys_log` VALUES ('2093680614658756610', '1', '编辑系统配置', 'io.charlie.web.modular.sys.config.controller.SysConfigController.edit', '[{\"id\":\"1982136140003225607\",\"value\":\"06a529dcc13e4e98a81d741b7673475f.jpg\"}]', '0:0:0:0:0:0:0:1', '2026-08-29 20:42:09', 'OPERATION', 'SYS', '', 'SUCCESS', NULL, 0, '2026-08-29 20:42:12', '1', '2026-08-29 20:42:12', '1');
...
INSERT INTO `sys_menu` VALUES ('1979358311883591681', '0', 'outweb_index', '/outweb', NULL, '外部管理', 'icon-park-outline:application-two', 0, 1, 14, 0, 0, '[]', 1, '2025-10-21 12:25:12', '1', '2026-08-29 20:07:00', '1', NULL);
INSERT INTO `sys_menu` VALUES ('1979359562444050434', '1979358311883591681', 'dozzle120', '/outweb/dozzle120', '/outweb/index.vue', '120服务器日志', 'icon-park-outline:log', 0, 1, 3, 1, 1, '[]', 1, '2025-10-21 12:25:12', '1', '2026-08-29 20:06:45', '1', '{\n    \"href_inner\": \"http://120.26.180.149:9001/\"\n}');
INSERT INTO `sys_menu` VALUES ('1979779968216379394', '1979358311883591681', 'dozzle47', '/outweb/dozzle47', '/outweb/index.vue', '47服务器日志', 'icon-park-outline:log', 0, 1, 2, 1, 1, '[]', 1, '2025-10-21 12:25:12', '1', '2026-08-29 20:06:51', '1', '{\r\n    \"href_inner\": \"http://47.99.236.69:9001/\"\r\n}');
INSERT INTO `sys_menu` VALUES ('1979781411367333889', '1979358311883591681', 'portainer', '/outweb/portainer', '/outweb/index.vue', 'Portainer', 'icon-park-outline:application', 0, 1, 4, 1, 1, '[]', 1, '2025-10-21 12:25:12', '1', '2026-08-29 20:06:42', '1', '{\r\n    \"href_inner\": \"http://101.201.174.43:9020/\"\r\n}');
INSERT INTO `sys_menu` VALUES ('1979784519254323202', '1979358311883591681', 'nacos', '/outweb/nacos', '/outweb/index.vue', 'Nacos', 'icon-park-outline:link-cloud', 0, 1, 5, 0, 1, '[]', 1, '2025-10-21 12:25:12', '1', '2026-08-29 20:06:54', '1', '{\r\n    \"href_outter\": \"http://120.26.180.149:8848/nacos\"\r\n}');
INSERT INTO `sys_menu` VALUES ('1979788036882870274', '1979358311883591681', 'minio', '/outweb/minio', '/outweb/index.vue', 'Minio', 'icon-park-outline:file-cabinet', 0, 1, 6, 0, 1, '[]', 1, '2025-10-21 12:25:12', '1', '2026-08-29 20:06:57', '1', '{\r\n    \"href_outter\": \"http://120.26.180.149:9090/\"\r\n}');
INSERT INTO `sys_menu` VALUES ('1979792211910332418', '1979358311883591681', 'dozzle101', '/outweb/dozzle101', '/outweb/index.vue', '101服务器日志', 'icon-park-outline:log', 0, 1, 1, 1, 1, '[]', 1, '2025-10-21 12:25:12', '1', '2026-08-29 20:06:48', '1', '{\r\n    \"href_inner\": \"http://101.201.174.43:9995/\"\r\n}');
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('1983074367356579842', '平台判题机制说明公告', '710905dfd06a4adc9daf8094d399eee2.jpg', '', 2, '亲爱的用户：\n\n为了帮助大家更好地理解我们平台的判题机制，提高编程练习的效率，现将平台的判题流程和注意事项说明如下：\n\n## 判题流程概述\n\n我们的判题系统采用标准化流程对您的提交进行评测，具体流程如下：\n\n```mermaid\ngraph TD\n    A[用户提交代码] --> B[等待判题]\n    B --> C[编译代码]\n    C --> D{编译是否成功?}\n    D -->|否| E[编译错误]\n    D -->|是| F[运行程序]\n    F --> G[比对输出]\n    G --> H{输出是否正确?}\n    H -->|完全正确| I[答案正确]\n    H -->|部分正确| J[部分正确]\n    H -->|错误| K[答案错误]\n    F --> L{是否超时?}\n    L -->|是| M[时间超出限制]\n    F --> N{内存是否超限?}\n    N -->|是| O[内存超出限制]\n    F --> P{是否运行时错误?}\n    P -->|是| Q[运行时错误]\n```\n\n## 各编程语言配置说明\n\n| 语言 | 源文件要求 | 编译命令 | 运行命令 |\n|------|------------|----------|----------|\n| Go | Main.go | `go build -o Main Main.go` | `./Main` |\n| Java | Main.java | `javac -d . Main.java` | `java Main` |\n| C | Main.c | `gcc Main.c -o Main` | `./Main` |\n| C++ | Main.cpp | `g++ Main.cpp -o Main` | `./Main` |\n| Python | Main.py | 无需编译 | `python3 Main.py` |\n\n## 判题状态说明\n\n| 状态类型 | 状态代码 | 含义说明 |\n|----------|----------|----------|\n| 成功状态 | `ACCEPTED` | 程序输出完全正确 |\n| 成功状态 | `PARTIAL_ACCEPTED` | 程序输出部分正确 |\n| 编译相关 | `COMPILATION_ERROR` | 源代码编译失败 |\n| 编译相关 | `COMPILED_OK` | 源代码编译成功 |\n| 运行相关 | `TIME_LIMIT_EXCEEDED` | 程序运行超时 |\n| 运行相关 | `MEMORY_LIMIT_EXCEEDED` | 内存使用超限 |\n| 运行相关 | `RUNTIME_ERROR` | 程序运行时出错 |\n| 输出相关 | `WRONG_ANSWER` | 程序输出答案错误 |\n| 输出相关 | `PRESENTATION_ERROR` | 输出格式不符合要求 |\n\n## 重要注意事项\n\n### 1. 代码规范要求\n- **文件命名**：系统文件将命名为`Main`（具体如`Main.java`、`Main.py`等）\n- **入口类**：Java程序必须包含`Main`类，且该类应为`public`\n- **程序入口**：所有程序都应有`main`函数作为程序入口点\n\n### 2. 输入输出要求\n- 使用标准输入输出（`stdin/stdout`）\n- 不要使用文件输入输出，否则会导致判题失败\n- 输出格式必须与题目要求完全一致，包括空格、换行（末尾换行将忽略）等\n\n### 3. 资源限制\n- **时间限制**：各题目有不同的时间限制，通常在`1-10`秒（显示为`ms`）之间\n- **内存限制**：通常为`1MB-250MB`（显示为`KB`），请避免创建过大的数据结构\n\n### 4. 常见问题解决\n- **编译错误**：检查语法错误、缺少分号、括号不匹配等\n- **运行时错误**：检查数组越界、空指针、除零错误等\n- **时间超限**：优化算法时间复杂度，避免无效循环\n- **内存超限**：减少不必要的内存分配，使用更高效的数据结构\n\n## 建议与技巧\n\n1. **本地测试**：在提交前务必在本地进行充分测试\n2. **边界情况**：特别注意输入数据的边界条件测试\n3. **特殊值**：考虑空输入、极大值、极小值等情况\n4. **代码简洁**：避免不必要的复杂逻辑，保持代码清晰\n\n如果您在判题过程中遇到任何问题，或有改进建议，欢迎通过反馈渠道联系我们。祝您编程愉快！\n\n平台技术团队敬上', 0, '2025-10-28 15:32:28', '1', '2026-08-29 20:29:53', '1', 1);
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_role_menu_id`(`role_id` ASC, `menu_id` ASC) USING BTREE,
...
INSERT INTO `sys_user_role` VALUES ('2093673426368200705', '2093673426108153857', '3');
...
CREATE TABLE `task_similarity`  (
  ...
  `update_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_task_id_similarity`(`task_id` ASC, `similarity` ASC) USING BTREE,
  INDEX `idx_problem_submit_user`(`problem_id` ASC, `submit_user` ASC) USING BTREE,
  INDEX `idx_problem_similarity`(`problem_id` ASC, `similarity` ASC) USING BTREE,
  INDEX `idx_module_type_id`(`module_type` ASC, `module_id` ASC) USING BTREE,
