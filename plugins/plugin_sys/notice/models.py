...
class SysNotice(Base):
    ...
    level: Mapped[Optional[str]] = mapped_column(VARCHAR(16, charset='utf8mb4', collation='utf8mb4_general_ci'), default="NORMAL", server_default=text("'NORMAL'"), comment='通知级别')
    status: Mapped[Optional[str]] = mapped_column(VARCHAR(16, charset='utf8mb4', collation='utf8mb4_general_ci'), default="DRAFT", server_default=text("'DRAFT'"), comment='状态')
    sort_code: Mapped[Optional[int]] = mapped_column(INTEGER, default=0, server_default=text("0"), comment='排序')
    is_top: Mapped[Optional[str]] = mapped_column(VARCHAR(8, charset='utf8mb4', collation='utf8mb4_general_ci'), default="NO", server_default=text("'NO'"), comment='是否置顶')
