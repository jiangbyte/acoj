...
class SysBanner(Base):
    ...
    link_type: Mapped[Optional[str]] = mapped_column(VARCHAR(16, charset='utf8mb4', collation='utf8mb4_general_ci'), default="URL", server_default=text("'URL'"), comment='链接类型')
    ...
    view_count: Mapped[Optional[int]] = mapped_column(INTEGER, default=0, server_default=text("0"), comment='浏览次数')
    click_count: Mapped[Optional[int]] = mapped_column(INTEGER, default=0, server_default=text("0"), comment='点击次数')
