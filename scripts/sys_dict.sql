...
INSERT INTO "public"."sys_dict" VALUES ('100119', 'RESOURCE_MODULE_CLIENT', '资源模块客户端', 'RESOURCE_MODULE_CLIENT', '#2563eb', 'SYS', NULL, 'ENABLED', 0, '2026-07-03 00:00:00+00', NULL, '2026-07-23 22:49:47.723638+00', '1');
INSERT INTO "public"."sys_dict" VALUES ('7486199847796740096', 'CS', 'cs', 'cs', '#f0a020', 'BIZ', NULL, 'ENABLED', 99, '2026-07-23 23:25:30.572866+00', '1', '2026-07-23 23:29:21.112674+00', '1');
...
-- ----------------------------
-- ----------------------------
-- Records of sys_dict for message module
-- ----------------------------
INSERT INTO "public"."sys_dict" VALUES ('100122', 'NOTIFICATION_SEVERITY', '严重等级', 'NOTIFICATION_SEVERITY', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100123', 'NOTIFICATION_SEVERITY_INFO', '信息', 'info', '#2080f0', 'SYS', '100122', 'ENABLED', 1, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100124', 'NOTIFICATION_SEVERITY_WARNING', '警告', 'warning', '#f0a020', 'SYS', '100122', 'ENABLED', 2, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100125', 'NOTIFICATION_SEVERITY_ERROR', '错误', 'error', '#d03050', 'SYS', '100122', 'ENABLED', 3, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100126', 'NOTIFICATION_SEVERITY_CRITICAL', '严重', 'critical', '#d03050', 'SYS', '100122', 'ENABLED', 4, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100127', 'CONTENT_TYPE', '内容格式', 'CONTENT_TYPE', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100128', 'CONTENT_TYPE_TEXT', '纯文本', 'text', '#909399', 'SYS', '100127', 'ENABLED', 1, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100129', 'CONTENT_TYPE_HTML', '富文本', 'html', '#18a058', 'SYS', '100127', 'ENABLED', 2, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100130', 'CONTENT_TYPE_MARKDOWN', 'Markdown', 'markdown', '#722ed1', 'SYS', '100127', 'ENABLED', 3, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100131', 'TARGET_SCOPE', '目标范围', 'TARGET_SCOPE', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100132', 'TARGET_SCOPE_ALL', '全部', 'ALL', '#2080f0', 'SYS', '100131', 'ENABLED', 1, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100133', 'TARGET_SCOPE_DEPARTMENT', '部门', 'DEPARTMENT', '#18a058', 'SYS', '100131', 'ENABLED', 2, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100134', 'TARGET_SCOPE_ROLE', '角色', 'ROLE', '#f0a020', 'SYS', '100131', 'ENABLED', 3, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100135', 'TARGET_SCOPE_SPECIFIC', '指定用户', 'SPECIFIC', '#d03050', 'SYS', '100131', 'ENABLED', 4, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;

INSERT INTO "public"."sys_dict" VALUES ('100136', 'NOTIFY_LOCATION', '通知位置', 'NOTIFY_LOCATION', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100137', 'NOTIFY_LOCATION_CENTER', '通知中心', 'center', '#2080f0', 'SYS', '100136', 'ENABLED', 1, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100138', 'NOTIFY_LOCATION_POPUP', '弹窗', 'popup', '#f0a020', 'SYS', '100136', 'ENABLED', 2, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100139', 'NOTIFY_LOCATION_DASHBOARD', '工作台公告区', 'dashboard', '#722ed1', 'SYS', '100136', 'ENABLED', 3, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;

INSERT INTO "public"."sys_dict" VALUES ('100140', 'FEEDBACK_CATEGORY', '反馈分类', 'FEEDBACK_CATEGORY', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100141', 'FEEDBACK_CATEGORY_SUGGESTION', '功能建议', 'SUGGESTION', '#18a058', 'SYS', '100140', 'ENABLED', 1, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100142', 'FEEDBACK_CATEGORY_BUG', '问题反馈', 'BUG', '#d03050', 'SYS', '100140', 'ENABLED', 2, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100143', 'FEEDBACK_CATEGORY_OTHER', '其他', 'OTHER', '#909399', 'SYS', '100140', 'ENABLED', 3, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;

INSERT INTO "public"."sys_dict" VALUES ('100144', 'FEEDBACK_STATUS', '反馈状态', 'FEEDBACK_STATUS', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100145', 'FEEDBACK_STATUS_PENDING', '待处理', 'PENDING', '#f0a020', 'SYS', '100144', 'ENABLED', 1, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100146', 'FEEDBACK_STATUS_REVIEWED', '已查看', 'REVIEWED', '#2080f0', 'SYS', '100144', 'ENABLED', 2, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100147', 'FEEDBACK_STATUS_RESOLVED', '已解决', 'RESOLVED', '#18a058', 'SYS', '100144', 'ENABLED', 3, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100148', 'FEEDBACK_STATUS_CLOSED', '已关闭', 'CLOSED', '#909399', 'SYS', '100144', 'ENABLED', 4, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;

INSERT INTO "public"."sys_dict" VALUES ('100149', 'PUBLISH_STATUS', '发布状态', 'PUBLISH_STATUS', '#2080f0', 'SYS', NULL, 'ENABLED', 0, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100150', 'PUBLISH_STATUS_DRAFT', '草稿', 'DRAFT', '#909399', 'SYS', '100149', 'ENABLED', 1, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100151', 'PUBLISH_STATUS_PUBLISHED', '已发布', 'PUBLISHED', '#18a058', 'SYS', '100149', 'ENABLED', 2, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
INSERT INTO "public"."sys_dict" VALUES ('100152', 'PUBLISH_STATUS_REVOKED', '已撤回', 'REVOKED', '#d03050', 'SYS', '100149', 'ENABLED', 3, '2026-07-24 00:00:00+00', NULL, '2026-07-24 00:00:00+00', NULL) ON CONFLICT (code) DO NOTHING;
